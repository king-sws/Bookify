    ...
    <div className='admin-sidebar' >
        ...
        <div className="logo">
          <Image
            ...
            width={37}
          />
          <h1 className="text-2xl font-semibold text-primary-admin">Bookify</h1>
        </div>
                        ...
                        <Link key={link.route} href={link.route} >
                            <div className={cn("link", isSelected && "bg-primary-admin shadow-sm ")}>
                                <div className="relative size-5">
                                    <Image src={link.img} alt={link.text} fill className={`${isSelected ? "brightness-0 invert " : "" } object-contain`} />
                                </div>
